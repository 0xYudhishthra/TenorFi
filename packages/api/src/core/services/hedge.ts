...
type LifiClient = ReturnType<typeof createLifiClient>;
type DepositStep = Awaited<ReturnType<typeof buildHyperCoreDeposit>>;
type OpenStep = Awaited<ReturnType<typeof buildOpenCall>>;
...
export function createHedgeService(opts: HedgeServiceOptions): HedgeService {
  const client = opts.client ?? createLifiClient();
