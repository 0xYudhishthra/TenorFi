...
export default function ExplorerClient() {
  ...
  const onSearchSubmit = (e: React.FormEvent) => {
    ...
    if (d.kind === "position") {
      if (POSITIONS.some((s) => s.id === Number(d.val))) router.push(`/explorer/${d.val}`);
    ...
    <main className="wrap exp">
      <div className="exp-head">
        ...
        <div className="badge badge-up">
          <span className="ping" style={{ width: 7, height: 7 }} /> Live · funding from
          Hyperliquid
        </div>
      </div>
      ...
      <div className="exp-grid">
        <div className="panel card">
          ...
          <FundingChart onHover={setHoverAfr} />
