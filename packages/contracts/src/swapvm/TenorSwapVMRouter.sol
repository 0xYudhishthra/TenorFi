...
/// @title TenorSwapVMRouter — a SwapVM router that includes the `_fundingSettle` instruction
/// @notice Composes `Simulator, SwapVM, TenorOpcodes`, where `TenorOpcodes` extends the standard
///         Aqua opcode set with `_fundingSettle`. Deploy this router to execute funding-
///         settlement programs.
contract TenorSwapVMRouter is Simulator, SwapVM, TenorOpcodes {
